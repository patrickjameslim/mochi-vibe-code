...
import { Tooltip, TooltipProvider, TooltipRoot, TooltipTrigger, TooltipContent } from './ui/Tooltip';
...
export default function CustomerViewPage({ customer, groups, onBack, onEdit, onCreateBill }: Props) {
