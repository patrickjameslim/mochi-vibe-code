...
import { TooltipInfo, TooltipInfoProps } from '../TooltipInfo'
...
const fieldLabelVariants = cva(
  [
    'group/field-label peer/field-label inline w-fit leading-snug group-data-[disabled=true]/field:opacity-50',
    ...
    >
      ...
      {(required || tooltip) && (
        <span className="inline-flex items-center align-middle">
          ...
          {tooltip && <TooltipInfo {...tooltip} className="-mt-0.5 ml-1" />}
        </span>
      )}
    </Label>
  )
...
/**
 * @reference https://ui.shadcn.com/docs/components/field#fielderror
 */
const FieldError = ({
  className,
  children,
